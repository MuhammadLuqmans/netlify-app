...
const Modal = ({
 ...
 ...props
  ...
  const buyToken = () => {
    if (paymentAmount!== "") {
      setPresaleStatus(null);
      write?.({ value: parseEther(paymentPrice.toString()), args: [buyAmount] });
      makeEmptyInputs();
    } else {
